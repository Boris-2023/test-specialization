...
/**
 * Class Hamster extending Pet; bears data on the animal as name, type, birthdate, commands
 * the animal can execute and number of times a day the animal must be walked
 */
public class Hamster extends Pet {

    /**
     * @apiNote basic constructor for class Hamster
     ...
     */
    public Hamster(String name, String type, String dateBirth, String commands, Integer needWalkPerDayNum) {
